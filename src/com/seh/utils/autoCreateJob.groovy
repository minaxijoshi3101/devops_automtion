      ...
      try{ 
            ...
            usernameVariable: 'USER', passwordVariable: 'PASSWORD']]) {
                  sh """
                        ...
                        curl -s -XPOST 'http://192.168.18.6:8080/view/SEH/job/SEH_common/createItem?name=sonar_scan' --data-binary @sonar_scan.xml -H "Content-Type:text/xml" -u "${USER}:1118a269715e91e16144ecae875f87060f" -H "\$CRUMB"
