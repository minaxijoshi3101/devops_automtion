...
def call(String repo,String appName) {
      ...
      sh """
            ...
            curl -X POST -u ${USER}:${PASSWORD} "http://192.168.18.11:8080/createItem?name=${appName}&mode=com.cloudbees.hudson.plugins.folder.Folder" --data-urlencode "json={ 'name': '${appName}', 'mode': 'com.cloudbees.hudson.plugins.folder.Folder', 'Submit': 'OK' }"
