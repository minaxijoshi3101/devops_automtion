...
def call(String repo,String appName) {
      ...
      sh """
            ...
            curl -XPOST 'http://192.168.18.9:8080/createItem?name=${appName}&mode=com.cloudbees.hudson.plugins.folder.Folder&from=&json=%7B%22name%22%3A%22${appName}' --user ${USER}:${PASSWORD} -H "\$CRUMB" -H "Content-Type:application/x-www-form-urlencoded"
